...
public class PostItStoryRenderer implements GLSurfaceView.Renderer
{
    private static final String LOGTAG = "PostItStoryRenderer";

    SampleApplicationSession vuforiaAppSession;
    PostItStory mActivity;
    ...
    public PostItStoryRenderer(PostItStory activity,
